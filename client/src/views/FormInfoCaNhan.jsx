...
import { faImage, faArrowRightFromBracket } from "@fortawesome/free-solid-svg-icons"
import {
  getTKCoSoByIdTK,
  getTKUserByIdTK,
  updateTkByIdTK
...
const FormInfoCaNhan = ({ onOpenFormResPass }) => {
  ...
  return (
    <div className="pt-5">
      ...
      <div className="w-[80%] mx-auto justify-end flex my-5">
        <div onClick={() => goLogin()} className="bg-slate-300 w-auto p-3 flex gap-3 justify-between rounded-[10px] cursor-pointer hover:bg-[#379E13]">Đăng xuất <Icon24px classIcon={faArrowRightFromBracket} /></div>
      </div>
      <div className='w-[80%] mx-auto bg-[#379E13] border-[3px] border-[#F00000] h-[500px] rounded-[10px]'>
                ...
                <div className='row-span-1 h-[auto] my-[5px] '>
                  <div className='mx-5 ml-0 flex justify-between font-[600]'>
                    ...
                    <button class=" w-[32.5%] mr-[0.5%] h-[50px] text-[15px] text-[#FFFFFF] bg-[#6BA6FF] font-[600] rounded-[5px] "
                      onClick={onOpenFormResPass}>Đổi mật khẩu</button>
