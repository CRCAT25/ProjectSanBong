...
import { OpenTab, CGetAllCoSo, CThemTaiKhoan, ShowImgCoSo, CSearchEmailSdt, CDisableAcc, CEnableAcc, CGetAllPlayer, CGetAllAdmin, CGetAllBillComplete, CSearchHoaDonByDateAdmin } from "../controllers/CQuanLyTaiKhoan";
...
const Admin = () => {
  ...
  const ThemTaiKhoan = async (idphanquyen, ten, email, sdt, stringdiachi, nganhang, stk, matkhau) => {
    let resultcheck = await CheckInput(idphanquyen);
    if (idphanquyen === 2) {
      if (resultcheck == true) {
        stringdiachi = duong + ", " + phuong + ", " + quan + ", " + tinh;
        let result = await CThemTaiKhoan(idphanquyen, ten, email, sdt, stringdiachi, nganhang, stk, matkhau)
  ...
  const SearchSdtEmail = async (idphanquyen, stringsearch) => {
    if (stringsearch !== "") {
  ...
  const GetStateTK = async (trangthai, idtaikhoan) => {
    if(trangthai == 1){
      Enable(idtaikhoan);
    } else {
      Disable(idtaikhoan);
          ...
          <div className="w-[300px] h-[96px]  fixed  top-0 bg-white">
            <div className=" item-center justify-center w-full">
              <div className=" gap-3 justify-center bg-[#E2EDFF] h-[570px]">
                ...
                <button id="tablink" className={`tablink ${activeTab === 'khachhang' ? 'active' : ''} `} data-electronic="khachhang" onClick={() => openTab('khachhang', 0, 1)}><div id="tenmenu" className="tenmenu" ><Iconpx classIcon={faUser} width={"19px"} height={"19px"} marginRight={"15px"} marginLeft={"0px"} color={"black"} />Khách hàng</div></button>
          ...
          <div class="wrapper_tabcontent font-bold">
            {activeTab == ""? (
              ...
              <div className="w-full col-span-2">
                  ...
                  <div className="w-full h-[570px] col-span-10 text-center flex flex-col justify-center translate-y-[-100px]">
                    <div className="text-[30px]">Trang Quản trị hệ thống</div>
                  </div>
              </div>
              <div className="w-full grid grid-cols-12 bg-[#256eb3] h-[60px] mb-[36px] translate-y-[-100px]">
                </div>
                ...
                <div className="w-full col-span-10">
                  ...
                  <div id="" className=" w-full mx-auto">
                    ...
                    <div className="w-full grid grid-cols-6 gap-[10px] mb-[30px] px-[60px]">
                      ...
                      <div className="col-span-2 flex justify-between">
                        <button id="btnthemcs" className="col-span-2" onClick={() => ThemTaiKhoan(idphanquyen, ten, email, sdt, stringdiachi, nganhangcs, stkcs, matkhau)}>Thêm tài khoản</button>
                      </div>
                    </div>
                    ...
                    <div className="w-full flex mt-[120px] px-[60px] justify-center gap-[60px]">
                      ...
                      <div className="col-span-1 flex ">
                        ...
                        <div className="ml-[-12px] hover:cursor-pointer mt-[10px]" onClick={() => SearchSdtEmail(idphanquyen, stringsearch)}><Iconpx classIcon={faMagnifyingGlass} width={"23px"} height={"23px"} marginRight={"15px"} marginLeft={"-25px"} color={"black"} /></div>
                      </div>
                  ...
                  <div className="w-full grid grid-cols-12 bg-[#ffffff] mt-[10px] h-[100px]">
                    {listPlayer.map((player, i) => (
                      <React.Fragment key={i}>
                        ...
                        {player.TrangThai == 1 ? (
                          <div className="col-span-1 text-[#000000] text-center pt-[30px] cursor-pointer" onClick={() => GetStateTK(player.TrangThai, player.IdAccount)}><Iconpx classIcon={faXmark} width={"23px"} height={"23px"} marginRight={"15px"} marginLeft={"-25px"} color={"red"} /></div>
                        ) : (
                          <div className="col-span-1 text-[#000000] text-center pt-[30px] cursor-pointer" onClick={() => GetStateTK(player.TrangThai, player.IdAccount)}><Iconpx classIcon={faCheck} width={"23px"} height={"23px"} marginRight={"15px"} marginLeft={"-25px"} color={"green"} /></div>
                        )}
                ...
                <div className="w-full col-span-10">
                  ...
                  <div id="" className=" w-full mx-auto">
                    ...
                    <div className="w-full grid grid-cols-6 gap-[10px] mb-[30px] px-[60px]">
                      ...
                      <button id="btnthemcs" className="col-span-2" onClick={() => ThemTaiKhoan(idphanquyen, ten, email, sdt, stringdiachi, nganhangcs, stkcs, matkhau)}>Thêm cơ sở</button>
                    ...
                    <div className="w-full flex mt-[50px] px-[60px] justify-center gap-[60px]">
                      ...
                      <div className="col-span-1 flex ">
                        <input type="text" class="input_searchemailsopart" id="rssearch" placeholder="" onChange={e => setstringsearch(e.target.value)}></input>
                        <div className="ml-[-12px] hover:cursor-pointer mt-[10px]" onClick={() => SearchSdtEmail(idphanquyen, stringsearch)}><Iconpx classIcon={faMagnifyingGlass} width={"23px"} height={"23px"} marginRight={"15px"} marginLeft={"-25px"} color={"black"} /></div>                  </div>
                  ...
                  <div className="w-full grid grid-cols-12 bg-[#ffffff] h-[100px]">
                    {listPartner.map((coso, i) => (
                      <React.Fragment key={i}>
                        ...
                        {coso.TrangThai == 1 ? (
                          <div className="col-span-1 text-[#000000] text-center pt-[30px] hover:text-[red]  cursor-pointer" onClick={() => GetStateTK(coso.TrangThai, coso.IdAccount)}><Iconpx classIcon={faXmark} width={"23px"} height={"23px"} marginRight={"15px"} marginLeft={"-25px"} color={"red"} /></div>
                        ) : (
                          <div className="col-span-1 text-[#000000] text-center pt-[30px] hover:text-[red] cursor-pointer" onClick={() => GetStateTK(coso.TrangThai, coso.IdAccount)}><Iconpx classIcon={faCheck} width={"23px"} height={"23px"} marginRight={"15px"} marginLeft={"-25px"} color={"green"} /></div>
                        )}
